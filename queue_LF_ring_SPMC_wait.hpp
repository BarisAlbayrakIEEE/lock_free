#ifndef QUEUE_LF_RING_SPMC_WAIT_HPP
#define QUEUE_LF_RING_SPMC_WAIT_HPP
...
public:
    ...
    auto pop() -> T {
        while (true) {
            ...
            T data = std::move(_ring_buffer[index]);
            _size.notify_one();
...
#endif // QUEUE_LF_RING_SPMC_WAIT_HPP
