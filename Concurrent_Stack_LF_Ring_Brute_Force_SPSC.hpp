// Concurrent_Stack_LF_Ring_Brute_Force_SPSC
//
// Description:
//   The brute force solution for the lock-free/SPSC/ring stack problem:
...
//
// CAUTION:
//   This is a simple conceptual model for a lock-free/ring-buffer/SPSC stack problem
...
//
// See Concurrent_Stack_LF_Ring_Ticket_SPSC for ticket-based version
// which guarantees lock-free execution regardless of the contention.

#ifndef CONCURRENT_STACK_LF_RING_BRUTE_FORCE_SPSC_HPP
...
namespace BA_Concurrency {
    ...
    template <
        typename T,
        unsigned char Capacity_As_Pow2>
    using stack_LF_ring_brute_force_SPSC = Concurrent_Stack<
        true,
        Enum_Structure_Types::Static_Ring_Buffer,
        Enum_Concurrency_Models::SPSC,
        T,
...
#endif // CONCURRENT_STACK_LF_RING_BRUTE_FORCE_SPSC_HPP
